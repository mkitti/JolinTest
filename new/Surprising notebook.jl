...
# ╔═╡ 1a1bbad2-367e-11ee-3325-9b55a2803a9a
begin
	using Plots
	using PlutoUI
end

# ╔═╡ 5cdd6ebf-8c25-47e4-a2f0-a92e5016ab1b
begin
	md"Number of points: $(@bind numpts Slider(1:100))"
end

# ╔═╡ c656e3d7-d516-4c76-9fc5-ef49895485a4
begin
	Y = rand([-1,0,1],numpts)
	plot(Y)
	plot!(cumsum(Y))
